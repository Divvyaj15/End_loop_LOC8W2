...
import { IconEvents as EventsIcon, IconMenu } from '../components/SidebarIcons';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#050816] via-[#05030c] to-[#060b1b] text-white flex">
      ...
      <aside className="w-20 lg:w-64 bg-black/40 backdrop-blur-xl border-r border-white/10 flex flex-col">
        <div className="h-20 flex items-center justify-between px-4 border-b border-white/10">
          <button
            type="button"
            className="flex items-center gap-2 text-white/90 hover:text-white transition-colors p-1"
            aria-label="Menu"
          >
        ...
        <nav className="flex-1 py-6 space-y-2 px-2 lg:px-4">
          <button
            type="button"
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl bg-cyan-500/15 border border-cyan-400/50 text-cyan-200 text-sm transition-all hover:bg-cyan-500/20 hover:shadow-[0_0_12px_rgba(0,217,255,0.2)] group"
          >
            <span className="w-8 h-8 rounded-lg bg-cyan-500/20 flex items-center justify-center text-cyan-200 group-hover:scale-110 transition-transform">
